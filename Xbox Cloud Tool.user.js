...
`;
    ...
    //★★ 1=开   0=关 ★★//
    let default_language_list = { 'Ngôn ngữ': 'Auto', 'TiengViet': 'en-US', '繁体': 'zh-TW' }
    let NFTconfig =
    {
        enableRemotePlay: 0,
        PATCH_ORDERS: [],
        ...
        regionBlock: {
            ...
            options: {
                'Hàn': '203.253.64.1',
                'Hoa Kỳ': '4.2.2.2',
                'Nhật Bản': '122.1.0.154'
            }
        },
        chooseLanguage: 1,
        IfErrUsedefaultGameLanguage: 'en-US',
        high_bitrate: 1,
        ...
        useCustomfakeIp: 0,
        customfakeIp: '',
        xcloud_game_language: default_language_list['TiengViet'],
    ...
    class StreamBadges {
        static get BADGE_PLAYTIME() { return 'giờ chơi'; };
        static get BADGE_BATTERY() { return 'pin'; };
        static get BADGE_IN() { return 'vào'; };
        static get BADGE_OUT() { return 'ra'; };

        static get BADGE_SERVER() { return 'máy chủ'; };
        static get BADGE_VIDEO() { return 'bộ giải mã'; };
        ...
        static async render() {
            ...
            if (StreamBadges.video) {
                ...
                if (StreamBadges.video.profile) {
                    ...
                    profile = profile.startsWith('4d') ? 'cao' : (profile.startsWith('42e') ? 'tb' : 'thap');
                    video += ` (${profile})`;
                }
            }
    ...
    class StreamStats {
        ...
        static start() {
            ...
            $('#xcloud_setting_STATS_BUTTON').text("tắt giám sát");
        ...
        static render() {
            ...
            StreamStats.#$container = CE('div', { 'class': 'better-xcloud-stats-bar better-xcloud-gone' },
                ...
                CE('div', { 'class': 'stats_rtt' }, CE('label', {}, 'rtt'),
                    StreamStats.#$rtt = CE('span', {}, '0ms')),
                CE('div', { 'class': 'stats_dt' }, CE('label', {}, 'dt'),
                    StreamStats.#$dt = CE('span', {}, '0ms')),
                CE('div', { 'class': 'stats_br' }, CE('label', {}, 'br'),
                    StreamStats.#$br = CE('span', {}, '0ms')),
                CE('div', { 'class': 'stats_pl' }, CE('label', {}, 'pl'),
                    StreamStats.#$pl = CE('span', {}, '0ms')),
                CE('div', { 'class': 'stats_fl' }, CE('label', {}, 'fl'),
            ...
            StreamStats.#$settings = CE('div', { 'class': 'better-xcloud-stats-settings' },
                ...
                CE('div', {},
                    CE('label', { 'for': `xcloud_setting_NFTconfig['STATS_SHOW_WHEN_PLAYING']` }, 'tự bắt đầu'),
                    $showStartup
                ),
                CE('div', {},
                    CE('label', {}, 'Vị trí'),
                ...
                CE('div', {},
                    CE('label', { 'for': `xcloud_setting_STATS_OPACITY` }, 'rõ ràng (10-100%)'),
                    $opacity
                ),
                CE('div', {},
                ...
                CE('div', {},
                    CE('label', { 'for': `xcloud_setting_STATS_CONDITIONAL_FORMATTING` }, 'màu'),
                    $formatting
                ),
                CE('div', {},
    ...
    function checkCodec() {
        ...
        const codecProfileMap = { "cao": "4d", "tb": "42e", "thấp": "420" };
        ...
        let sortOrder = ['mặc định', 'tự động', 'AV1', 'VP9', 'H265', 'VP8', 'H264cao', 'H264tb', 'H264thấp', 'flexfec-03', 'ulpfec', 'rtx', 'red'];
    ...
    const settingsConfig = [
        {
            ...
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'chooseLanguageOn' },
                { value: 0, text: 'tắt', id: 'chooseLanguageOff' }
            ],
        ...
        {
            label: 'Không cần VPN：',
            type: 'radio',
            name: 'noNeedVpn',
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'noNeedVpnOn' },
                { value: 0, text: 'tắt', id: 'noNeedVpnOff' },
            ],
        ...
        <input type='text' style="display: ` + (NFTconfig['useCustomfakeIp'] == 1 ? 'inline' : 'none')
                + `;outline: none;width: 125px;" id="customfakeIpInput" class="customfakeIpListener" value="${NFTconfig['customfakeIp']}" placeholder="Vui lòng nhập IP"/>`

        },
        {
            label: 'Chất lượng hình ảnh：',
            type: 'radio',
            name: 'highBitrate',
            display: 'block',
            options: [
        ...
        {
            label: 'Vô hiệu hóa kiểm tra mạng：',
            type: 'radio',
            name: 'disableCheckNetwork',
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'disableCheckNetworkOn' },
                { value: 0, text: 'tắt', id: 'disableCheckNetworkOff' }
            ],
            checkedValue: NFTconfig['disableCheckNetwork'],
            needHr: true
        },
        {
            label: 'Bật phím ảo：',
            type: 'radio',
            name: 'autoOpenOC',
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'autoOpenOCOn' },
                { value: 0, text: 'tắt', id: 'autoOpenOCOff' }
            ],
        ...
        id="autoShowTouch" ${NFTconfig['autoShowTouch'] == true ? 'checked' : ''}><label for="autoShowTouch" style="cursor: pointer;">tự động</label></div>`
        },
        {
            label: 'tắt phím ảo：',
            type: 'radio',
            name: 'disableTouchControls',
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'disableTouchControlsOn' },
                { value: 0, text: 'tắt', id: 'disableTouchControlsOff' },
            ],
            checkedValue: NFTconfig['disableTouchControls'],
            needHr: true
        },
        {
            label: 'tự động full màn：',
            type: 'radio',
            name: 'autoFullScreen',
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'autoFullScreenOn' },
                { value: 0, text: 'tắt', id: 'autoFullScreenOff' }
            ],
        ...
        },
        {
            ...
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'IPv6On' },
                { value: 0, text: 'tắt', id: 'IPv6Off' }
            ],
        ...
        ,
        {
            label: 'chặn Xcloud sever：',
            type: 'radio',
            name: 'blockXcloudServer',
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'blockXcloudServerOn' },
                { value: 0, text: 'tắt', id: 'blockXcloudServerOff' }
            ],
        ...
        },
        {
            ...
            display: 'block',
            options: [
                { value: 1, text: 'bật', id: 'antiKickOn' },
                { value: 0, text: 'tắt', id: 'antiKickOff' }
            ],
        ...
        {
            label: 'Thiết lập cửa sổ nổi：',
            type: 'radio',
            name: 'noPopSetting',
            display: 'block',
            options: [
                { value: 0, text: 'hiện', id: 'noPopSettingOff' },
                { value: 1, text: 'ẩn', id: 'noPopSettingOn' }
            ],
            checkedValue: NFTconfig['noPopSetting'],
            needHr: true
        },
        {
            label: 'Bật remote play：',
            type: 'radio',
            name: 'enableRemotePlay',
            display: 'block',
            options: [
                { value: 1, text: 'tắt', id: 'enableRemotePlayOn' },
                { value: 0, text: 'bật', id: 'enableRemotePlayOff' }
            ],
    ...
    function generateSettingElement(setting) {
        ...
        if (setting.type === 'radio') {
            ...
            settingHTML += `<label style="display: block;text-align:left;"><div style="display: inline;">${setting.label}</div>`;
            settingHTML += `
            <input type="text" style="display: inline;outline: none;width: 125px;" id="${setting.name}" class="${setting.name}Listener" value="${setting.value}" placeholder="vui lòng nhập${setting.label}"/>
        `;
            settingHTML += `</label>`;
    ...
    function generateSettingsPage() {
        ...
        <div style="padding: 10px;color: black;display:none;" class="settingsBackgroud" id="settingsBackgroud">
            <div class="settingsBox"><span class="blink-text" onclick="window.location.href='https://greasyfork.org/zh-CN/scripts/455741';">Cập nhật~</span>
    `;
        ...
        settingsHTML += `
                <button class="closeSetting1 closeSetting2" style="outline: none;">Đóng setting</button>
    ...
    function initSettingBox() {
        ...
        $(document).on('click', '.disableTouchControlsListener', function () {
            if ($(this).val() == 1) {
                if (!confirm("Bạn có chắc chắn muốn chặn không??")) {
    ...
    $(document).ready(function () {
        ...
        let checkTYFYIInterval = setInterval(() => {
            ...
            if (title.length > 0) {
                ...
                title.text("Tập lệnh phát hiện chức năng không có tác nhân không thành công và đang được làm mới tự động.");
                history.go(0);
                clearInterval(checkTYFYIInterval);
            }
        ...
        if (arguments[2].indexOf("/play/games/") > -1) {
            ...
            let checkPlayInterval = setInterval(() => {
                ...
                if (playButtons.length > 0) {
                    playButtons.text("Trò chơi này không có sẵn ở" + [NFTconfig['regionBlock']['blockIp']] + "để chơi, vui lòng sử dụng script để chuyển sang máy chủ khác và thử");
        ...
        const observer = new MutationObserver(mutationList => {
            mutationList.forEach(item => {
                ...
                item.addedNodes.forEach(async node => {
                    ...
                    // 创建视频调整
                    const $btnVideoSettings = cloneStreamMenuButton($orgButton, 'Điều chỉnh video', ICON_VIDEO_SETTINGS);
    ...
    function bindmslogoevent() {
        ...
        let linkElement = $("a:contains('⚙️ Cài đặt" + nftxboxversion + "')");
